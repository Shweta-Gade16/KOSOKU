  ...
  return (
    <section className="min-h-screen flex justify-center items-center px-10 py-28">
      <div className="w-full max-w-[1216px] rounded-2xl bg-white shadow-[0px_20px_72px_0px_rgba(13,53,75,0.15)] flex flex-wrap lg:flex-nowrap overflow-hidden">
        <div
          className="w-full lg:w-1/2 p-8 lg:p-12 bg-cover bg-center text-white flex flex-col"
        ...
        <div className="w-full lg:w-1/2 p-6 lg:p-12 flex flex-col gap-6">
          ...
          <form className="w-full flex flex-col gap-4">
            <div className="flex flex-col md:flex-row lg:flex-row gap-4">
              ...
              <InputField label="Last Name" value="Appleseed" />
            </div>

            <div className="flex flex-col md:flex-row lg:flex-row gap-4">
              <InputField label="Email Address" value="john@example.com" />
              <InputField label="Phone Number" value="+1-234-567-890" />
            </div>

            <InputField label="Company Name" value="Lorem Ipsum Inc." />
            <TextareaField label="Briefly describe your needs or challenges" value="Let us know how we can help you!" />
...
const TextareaField: React.FC<TextareaFieldProps> = ({ label, value }) => (
  <div className="w-full flex flex-col gap-2">
    <label className="text-sm font-medium">
      {label}
      <span className="text-pink-500">*</span>
