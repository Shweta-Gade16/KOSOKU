      ...
      <div className="flex flex-col md:flex-row flex-wrap gap-8 items-center md:items-start">
        <div className="w-full md:max-w-[1070px] flex flex-col gap-6 p-4 text-center md:text-left">
          ...
          <div className="flex flex-col md:items-start text-left md:text-left space-y-6">
            ...
            <button
              type="button"
              className="inline-flex items-center justify-center px-6 py-4 rounded-lg bg-white text-[#020961] font-poppins font-semibold text-sm sm:text-base md:text-lg leading-[160%] transition-all duration-300 hover:bg-gray-100 whitespace-nowrap flex-shrink-0">
